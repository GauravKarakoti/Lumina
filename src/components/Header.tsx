...
const Header = () => {
  ...
  return (
    ...
    <header className="fixed top-0 left-0 right-0 z-50 flex flex-col">
      ...
      <div className="bg-orange-600/90 text-white py-1.5 overflow-hidden relative shadow-sm z-50">
        <div className="animate-marquee whitespace-nowrap font-medium text-sm flex items-center gap-4">
          <span className="flex items-center gap-2">
            ...
            Due to unusually high traffic, document previews and pfp uploads are temporarily limited. Please check back in 24 hours.
          </span>
          <span className="flex items-center gap-2">
             • 
          </span>
      ...
      {/* Main Navigation */}
      <div className="border-b border-border/50 backdrop-blur-lg bg-background/80 w-full">
