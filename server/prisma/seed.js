...
var UNIT_TEMPLATES = [
    {
        title: function (lang) { return "Introduction to ".concat(lang); },
        description: function (lang) { return "Overview: what ".concat(lang, " is, history, typical use-cases"); },
        lessons: [
            {
                title: function (lang) { return "What is ".concat(lang, "?"); },
                questions: [
                    function (lang) { return "Which domain is ".concat(lang, " commonly used in?"); },
                    function (lang) { return "".concat(lang, " is primarily considered which kind of language?"); }
                ],
                options: function (lang, i) {
                    // i: question index
                    if (i === 0) {
                        return [
            ...
            {
                title: function (lang) { return "Setup & Tooling for ".concat(lang); },
                questions: [
                    function (lang) { return "Which command is commonly used to run ".concat(lang, " code?"); },
                    function (lang) { return "Which file extension is typical for ".concat(lang, " source files?"); }
                ],
                options: function (lang, i) {
                    if (i === 0) {
                        var runCmds = {
    ...
    {
        title: function (lang) { return "".concat(lang, " Syntax & Basics"); },
        description: function (lang) { return 'Variables, expressions, operators and basic syntax'; },
        lessons: [
            {
                title: function (lang) { return 'Variables & Types'; },
                questions: [
                    function (lang) { return "Which keyword (if any) is used to declare variables in ".concat(lang, "?"); },
                    function (lang) { return "Which type system does ".concat(lang, " primarily use?"); }
                ],
                options: function (lang, i) {
                    if (i === 0) {
                        var decl = {
            ...
            {
                title: function (lang) { return 'Expressions & Operators'; },
                questions: [
                    function (lang) { return "Which operator is used for equality comparison in ".concat(lang, "?"); },
                    function (lang) { return "Which operator increments a numeric value by 1 in ".concat(lang, "?"); }
                ],
                options: function (lang, i) {
                    if (i === 0) {
                        return [
    ...
    {
        title: function (lang) { return "".concat(lang, " Control Flow"); },
        description: function (lang) { return 'Conditionals, branching and loops'; },
        lessons: [
            {
                title: function (lang) { return 'Conditionals'; },
                questions: [
                    function (lang) { return "Which construct is used for multi-branch selection in ".concat(lang, "?"); },
                    function (lang) { return "Is ternary operator available in ".concat(lang, "?"); }
                ],
                options: function (lang, i) {
                    if (i === 0) {
                        return [
                        ...
                        var ternarySupported = !['SQL', 'Bash'].includes(lang);
                        return [
            ...
            {
                title: function (lang) { return 'Loops & Iteration'; },
                questions: [
                    function (lang) { return "Which loop is guaranteed to run at least once in ".concat(lang, "?"); },
                    function (lang) { return "Which common construct iterates a collection in ".concat(lang, "?"); }
                ],
                options: function (lang, i) {
                    if (i === 0) {
                        return [
    ...
    {
        title: function (lang) { return "".concat(lang, " Practical"); },
        description: function (lang) { return 'I/O, tooling, and small practical tasks'; },
        lessons: [
            {
                title: function (lang) { return 'Reading / Writing Data'; },
                questions: [
                    function (lang) { return "Which API is used for file reading in ".concat(lang, "?"); },
                    function (lang) { return "Which pattern helps auto-close resources (if applicable)?"; }
                ],
                options: function (lang, i) {
                    if (i === 0) {
                        return [
            ...
            {
                title: function (lang) { return 'Mini Challenge'; },
                questions: [
                    function (lang) { return "Which command builds or packages a ".concat(lang, " project?"); },
                    function (lang) { return "Which package manager is commonly used with ".concat(lang, "?"); }
                ],
                options: function (lang, i) {
                    if (i === 0) {
                        var build = {
...
function buildCoursePayload(lang) {
    var id = "".concat(slugify(lang), "-basics");
    var units = UNIT_TEMPLATES.map(function (unitTemplate, uIndex) {
        var unitTitle = unitTemplate.title(lang);
        var unitDescription = unitTemplate.description(lang);
        var lessons = unitTemplate.lessons.map(function (lessonTemplate, lIndex) {
            var lessonTitle = lessonTemplate.title(lang);
            var challenges = lessonTemplate.questions.map(function (qFn, qIndex) {
                var questionText = qFn(lang);
                var options = lessonTemplate.options(lang, qIndex);
                // Normalize options array to objects { text, correct: boolean }
                var optionsCreate = options.map(function (opt) { return ({
                    text: opt.text,
                    correct: !!opt.correct
                }); });
                return {
                    type: client_1.ChallengeType.SELECT,
    ...
    return {
        id: id,
        name: "".concat(lang, " Basics"),
        type: client_1.CourseType.LEARN,
        units: { create: units }
    };
}
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var _i, LANGUAGES_1, lang, payload, subjectsToCreate;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    lang = LANGUAGES_1[_i];
                    payload = buildCoursePayload(lang);
                ...
                case 2:
                    // Use upsert if you want idempotent seeds (avoid duplicates)
                    _a.sent();
                    console.log("Created/Updated course: ".concat(payload.name));
                    _a.label = 3;
                case 3:
                    _i++;
                    return [3 /*break*/, 1];
                ...
                case 5:
                    ...
                    return [4 /*yield*/, prisma.branch.createMany({
                            data: branches,
                            skipDuplicates: true,
                        })];
                case 6:
                    ...
                    return [4 /*yield*/, prisma.semester.createMany({
                            data: semesters,
                            skipDuplicates: true,
                        })];
                case 7:
                    ...
                    subjectsToCreate = subjects.map(function (s) { return ({
                        id: s.id,
                        name: s.name,
                        branchId: s.branch,
                        semesterId: s.semester,
                    }); });
                    return [4 /*yield*/, prisma.subject.createMany({
